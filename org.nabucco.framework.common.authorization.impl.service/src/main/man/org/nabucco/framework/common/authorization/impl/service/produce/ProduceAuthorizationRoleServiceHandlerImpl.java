 ...
 */
public class ProduceAuthorizationRoleServiceHandlerImpl extends ProduceAuthorizationRoleServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    public AuthorizationRoleMsg produceAuthorizationRole(EmptyServiceMessage msg) throws ProduceException {
        ...
        authorizationRole.setOwner(NabuccoInstance.getInstance().getOwner());
        authorizationRole.setTenant(super.getContext().getSubject().getTenant());
