 ...
 */
public class ResolveAuthorizationGroupListServiceHandlerImpl extends ResolveAuthorizationGroupListServiceHandler {
    ...
    protected AuthorizationGroupListMsg resolveAuthorizationGroupList(AuthorizationGroupListMsg msg)
        ...
        for (AuthorizationGroup group : groupList) {
            ...
            try {
                ...
                throw new ResolveException("Cannot resolve AuthorizationGroup with id " + group.getId(), e);
            } catch (Exception e) {
                throw new ResolveException("Cannot resolve AuthorizationGroup with id " + group.getId(), e);
            }
        }
