 ...
 */
public class ProduceAuthorizationGroupServiceHandlerImpl extends ProduceAuthorizationGroupServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    public AuthorizationGroupMsg produceAuthorizationGroup(EmptyServiceMessage msg) throws ProduceException {
        ...
        authorizationGroup.setOwner(NabuccoInstance.getInstance().getOwner());
        authorizationGroup.setTenant(super.getContext().getSubject().getTenant());
