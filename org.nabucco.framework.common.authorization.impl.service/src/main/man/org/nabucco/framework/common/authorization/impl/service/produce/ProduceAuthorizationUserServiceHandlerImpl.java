 ...
 */
public class ProduceAuthorizationUserServiceHandlerImpl extends
        ProduceAuthorizationUserServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    public AuthorizationUserMsg produceAuthorizationUser(EmptyServiceMessage msg)
        ...
        authorizationUser.setOwner(new Owner());
        authorizationUser.setUsername(new Name());
        authorizationUser.setDescription(new Description());
        authorizationUser.setUserType(new CodeType());
        authorizationUser.setPassword("nabucco");
