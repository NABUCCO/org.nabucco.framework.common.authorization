 ...
 */
public abstract class SearchAuthorizationPermissionServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<AuthorizationPermissionListMsg> invoke(ServiceRequest<AuthorizationSearchMsg> rq)
            throws SearchException {
     ...
     * @throws SearchException
     */
    protected abstract AuthorizationPermissionListMsg searchAuthorizationPermission(AuthorizationSearchMsg msg)
            throws SearchException;
