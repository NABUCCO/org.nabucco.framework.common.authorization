...
/**
 * MaintainAuthorizationGroupListServiceHandler<p/>Authorization maintenance service<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2010-01-18
 */
public abstract class MaintainAuthorizationGroupListServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.common.authorization.impl.service.maintain.MaintainAuthorizationGroupListServiceHandler";

    /** Constructs a new MaintainAuthorizationGroupListServiceHandler instance. */
    public MaintainAuthorizationGroupListServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<AuthorizationGroupListMsg> invoke(ServiceRequest<AuthorizationGroupListMsg> rq)
        ...
        try {
            ...
            msg = this.maintainAuthorizationGroupList(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MaintainException
     */
    protected abstract AuthorizationGroupListMsg maintainAuthorizationGroupList(AuthorizationGroupListMsg msg)
            throws MaintainException;
