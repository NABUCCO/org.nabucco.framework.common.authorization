...
public class SearchAuthorizationRoleTest extends RuntimeTestSupport {
    ...
    public void testSearchAuthorizationRole() throws Exception {
        ...
        AuthorizationRole role = AuthorizationTestUtility.create(component, AuthorizationTestUtility.dummyRole());
        ...
        ServiceResponse<AuthorizationRoleListMsg> rs = component.getSearchAuthorization().searchAuthorizationRole(rq);
