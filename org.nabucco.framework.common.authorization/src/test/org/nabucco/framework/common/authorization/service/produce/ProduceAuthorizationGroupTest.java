...
public class ProduceAuthorizationGroupTest extends RuntimeTestSupport {
    ...
    public void testProduceGroup() throws Exception {
        ...
        ServiceResponse<AuthorizationGroupMsg> srAuthorizationGroup = component
                .getProduceAuthorization().produceAuthorizationGroup(emptySR);
        ...
        AuthorizationGroup group = srAuthorizationGroup.getResponseMessage()
