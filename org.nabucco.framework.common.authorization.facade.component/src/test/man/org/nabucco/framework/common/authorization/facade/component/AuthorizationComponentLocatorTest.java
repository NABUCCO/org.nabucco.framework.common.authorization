...
/**
 * AuthorizationComponentLocatorTest
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class AuthorizationComponentLocatorTest {

    @Test
    public void testAuthorizationLookup() throws Exception {

        Connection connection = ConnectionFactory.getInstance().createConnection(
                new ConnectionSpecification(ConnectionType.JBOSS));

        AuthorizationComponent dynamicCodeComponent = AuthorizationComponentLocator.getInstance()
