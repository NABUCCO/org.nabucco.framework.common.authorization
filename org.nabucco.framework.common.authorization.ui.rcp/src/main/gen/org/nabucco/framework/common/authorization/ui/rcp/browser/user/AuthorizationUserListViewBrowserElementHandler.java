...
public interface AuthorizationUserListViewBrowserElementHandler extends CommandHandler {
     ...
     * 
     * @param element
     *            the AuthorizationUserListViewBrowserElement.
     * @param viewModel
     *            the AuthorizationUserListViewModel.
     */
     ...
     *            the BrowserElement.
     */
    void removeChild(final BrowserElement toBeRemoved, final AuthorizationUserListViewBrowserElement element);
}
