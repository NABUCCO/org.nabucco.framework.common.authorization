...
public class ReadAuthorizationRoleCommand implements NabuccoCommand {
    ...
    private ReadRoleHandler readRoleHandler = NabuccoInjector.getInstance(ReadAuthorizationRoleCommand.class).inject(
            ReadRoleHandler.class);
