 ...
 * @author Undefined
 */
public class AuthorizationPermissionListViewAuthorizationPermissionDescriptionLabelProvider implements ILabelProvider {

    /**
     * Constructs a new
     * AuthorizationPermissionListViewAuthorizationPermissionDescriptionLabelProvider instance.
     */
    ...
    public String getText(Object arg0) {
        ...
        if ((arg0 instanceof AuthorizationPermission)) {
            ...
            result = ((permission.getDescription() != null) ? permission.getDescription().toString() : "");
        }
        return result;
    }
