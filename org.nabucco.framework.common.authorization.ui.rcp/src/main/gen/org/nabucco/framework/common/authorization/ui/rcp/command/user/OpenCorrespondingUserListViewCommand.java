...
/**
 * OpenCorrespondingUserListViewCommand
 * <p/>
 * @TODO
 * <p/>
 * 
...
public class OpenCorrespondingUserListViewCommand implements NabuccoCommand {
    ...
    private OpenCorrespondingUserListViewHandler openCorrespondingUserListViewHandler = NabuccoInjector.getInstance(
            OpenCorrespondingUserListViewCommand.class).inject(OpenCorrespondingUserListViewHandler.class);
