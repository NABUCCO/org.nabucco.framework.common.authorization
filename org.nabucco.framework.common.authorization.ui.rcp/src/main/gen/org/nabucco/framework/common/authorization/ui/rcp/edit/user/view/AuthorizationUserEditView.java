...
/**
 * AuthorizationUserEditView<p/>Edit view for datatype AuthorizationUser<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2010-01-18
 */
public class AuthorizationUserEditView extends EditView<AuthorizationUserEditViewModel> {

    public static final String ID = "org.nabucco.framework.common.authorization.ui.edit.user.AuthorizationUserEditView";
    ...
    /** Constructs a new AuthorizationUserEditView instance. */
    public AuthorizationUserEditView() {
        super();
    }
    ...
    protected void createFormControl(Form form) {
        ...
        model = new AuthorizationUserEditViewModel();
