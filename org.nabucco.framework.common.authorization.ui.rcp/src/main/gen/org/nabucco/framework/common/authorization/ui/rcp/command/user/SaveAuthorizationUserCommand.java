...
public class SaveAuthorizationUserCommand implements NabuccoCommand {
    ...
    private SaveUserHandler saveUserHandler = NabuccoInjector.getInstance(SaveAuthorizationUserCommand.class).inject(
            SaveUserHandler.class);
