...
/**
 * OpenCorrespondingUserEditViewCommand
 * <p/>
 * @TODO
 * <p/>
 * 
...
public class OpenCorrespondingUserEditViewCommand implements NabuccoCommand {
    ...
    private OpenCorrespondingUserEditViewHandler openCorrespondingUserEditViewHandler = NabuccoInjector.getInstance(
            OpenCorrespondingUserEditViewCommand.class).inject(OpenCorrespondingUserEditViewHandler.class);
