...
/**
 * SearchAuthorizationUserCommand
 * <p/>
 * @TODO
 * <p/>
 * 
...
public class SearchAuthorizationUserCommand implements NabuccoCommand {
    ...
    private SearchUserHandler searchUserHandler = NabuccoInjector.getInstance(SearchAuthorizationUserCommand.class)
            .inject(SearchUserHandler.class);
