...
/**
 * AuthorizationPermissionUserPickerContentProvider
 * <p/>
 ...
 */
public class AuthorizationPermissionUserPickerContentProvider implements ElementPickerContentProvider,
        NabuccoInjectionReciever {

    private AuthorizationPermissionUserPickerContentProviderHandler handler = NabuccoInjector.getInstance(
            AuthorizationPermissionUserPickerContentProvider.class).inject(
     ...
     */
    public AuthorizationPermissionUserPickerContentProvider(AuthorizationPermissionEditViewModel viewModel) {
        super();
