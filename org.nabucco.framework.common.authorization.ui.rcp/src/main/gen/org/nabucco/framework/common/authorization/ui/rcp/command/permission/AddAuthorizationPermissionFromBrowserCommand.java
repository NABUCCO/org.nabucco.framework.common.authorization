...
/**
 * AddAuthorizationPermissionFromBrowserCommand
 * <p/>
 * Add an authorizationpermission to authorizationPermission from browserEntry.
 * <p/>
 * 
...
public class AddAuthorizationPermissionFromBrowserCommand implements NabuccoCommand {
    ...
    private AddPermissionFromBrowserHandler addPermissionFromBrowserHandler = NabuccoInjector.getInstance(
            AddAuthorizationPermissionFromBrowserCommand.class).inject(AddPermissionFromBrowserHandler.class);
