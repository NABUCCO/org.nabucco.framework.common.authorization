...
/**
 * AuthorizationPermissionEditViewWidgetFactory<p/>Edit view for datatype AuthorizationPermission<p/>
 *
 * @version 1.0
...
public class AuthorizationPermissionEditViewWidgetFactory extends WidgetFactory {
    ...
    public static final String OBSERVE_VALUE_AUTHORIZATIONPERMISSIONGROUPPICKER = AuthorizationPermissionEditViewModel.PROPERTY_GROUPSET_GROUPTYPE;
    ...
    public static final String OBSERVE_VALUE_AUTHORIZATIONPERMISSIONUSERPICKER = AuthorizationPermissionEditViewModel.PROPERTY_USERSET_USERTYPE;
    ...
    public static final String OBSERVE_VALUE_AUTHORIZATIONPERMISSIONROLEPICKER = AuthorizationPermissionEditViewModel.PROPERTY_ROLESET_ROLETYPE;
    ...
    public Label createLabelAuthorizationPermissionPermissionname(Composite parent) {
        return nabuccoFormToolKit.createRealLabel(parent,
    ...
    /**
     * CreateLabelAuthorizationPermissionType.
     *
     * @param parent the Composite.
     * @return the Label.
     */
    public Label createLabelAuthorizationPermissionType(Composite parent) {
        return nabuccoFormToolKit.createRealLabel(parent, LABEL_AUTHORIZATIONPERMISSIONTYPE);
    }

    /**
     * CreateInputFieldAuthorizationPermissionType.
     *
     * @param parent the Composite.
     * @return the Text.
     */
    public Text createInputFieldAuthorizationPermissionType(Composite parent) {
        Text result = nabuccoFormToolKit.createTextInput(parent);
        DataBindingContext bindingContext = new DataBindingContext();
        IObservableValue uiElement = SWTObservables.observeText(result, SWT.Modify);
        IObservableValue modelElement = BeansObservables.observeValue(model,
                OBSERVE_VALUE_AUTHORIZATIONPERMISSIONTYPE);
        bindingContext.bindValue(uiElement, modelElement, null, null);
        return result;
    }
     ...
     * @param parent the Composite.
     */
    public void createListPickerAuthorizationPermissionGroupPicker(Composite parent,
        ...
        ListPickerComposite picker = new ListPickerComposite(parent, SWT.NONE, params,
                params.getInputFieldLabelProvider(), new LabelForDialog(
                        ...
                        PATH_LABEL_AUTHORIZATIONPERMISSIONGROUPPICKER));
        DataBindingContext bindingContext = new DataBindingContext();
        ...
        modelElement = BeansObservables.observeValue(model,
                OBSERVE_VALUE_AUTHORIZATIONPERMISSIONGROUPPICKER);
        bindingContext.bindValue(uiElement, modelElement, null, null);
     ...
     * @param parent the Composite.
     */
    public void createListPickerAuthorizationPermissionUserPicker(Composite parent,
            ElementPickerParameter params) {
        ListPickerComposite picker = new ListPickerComposite(parent, SWT.NONE, params,
                params.getInputFieldLabelProvider(), new LabelForDialog(
                        TITLE_AUTHORIZATIONPERMISSIONUSERPICKER,
                        MESSAGE_AUTHORIZATIONPERMISSIONUSERPICKER,
                        SHELL_TITLE_AUTHORIZATIONPERMISSIONUSERPICKER,
                        MESSAGE_TABLE_AUTHORIZATIONPERMISSIONUSERPICKER,
                        MESSAGE_COMBO_AUTHORIZATIONPERMISSIONUSERPICKER,
                        PATH_LABEL_AUTHORIZATIONPERMISSIONUSERPICKER));
        DataBindingContext bindingContext = new DataBindingContext();
        IObservableValue uiElement;
        IObservableValue modelElement;
        uiElement = SWTObservables.observeText(picker.getInputText(), SWT.Modify);
        modelElement = BeansObservables.observeValue(model,
                OBSERVE_VALUE_AUTHORIZATIONPERMISSIONUSERPICKER);
        bindingContext.bindValue(uiElement, modelElement, null, null);
     ...
     * @param parent the Composite.
     */
    public void createListPickerAuthorizationPermissionRolePicker(Composite parent,
            ElementPickerParameter params) {
        ListPickerComposite picker = new ListPickerComposite(parent, SWT.NONE, params,
                params.getInputFieldLabelProvider(), new LabelForDialog(
                        TITLE_AUTHORIZATIONPERMISSIONROLEPICKER,
                        MESSAGE_AUTHORIZATIONPERMISSIONROLEPICKER,
                        SHELL_TITLE_AUTHORIZATIONPERMISSIONROLEPICKER,
                        MESSAGE_TABLE_AUTHORIZATIONPERMISSIONROLEPICKER,
                        MESSAGE_COMBO_AUTHORIZATIONPERMISSIONROLEPICKER,
        ...
        uiElement = SWTObservables.observeText(picker.getInputText(), SWT.Modify);
        modelElement = BeansObservables.observeValue(model,
                OBSERVE_VALUE_AUTHORIZATIONPERMISSIONROLEPICKER);
        bindingContext.bindValue(uiElement, modelElement, null, null);
