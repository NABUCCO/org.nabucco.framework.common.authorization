...
/**
 * AuthorizationGroupListViewWidgetFactory<p/>ListView for AuthorizationGroup<p/>
 *
 * @author Stefanie Feld, PRODYNA AG, 2010-03-15
 */
public class AuthorizationGroupListViewWidgetFactory extends WidgetFactory {

    /**
     * Constructs a new AuthorizationGroupListViewWidgetFactory instance.
     *
     * @param nabuccoFormToolKit the NabuccoFormToolkit.
     */
    public AuthorizationGroupListViewWidgetFactory(NabuccoFormToolkit nabuccoFormToolKit) {
