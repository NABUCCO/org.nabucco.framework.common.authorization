...
public class SaveAuthorizationGroupCommand implements NabuccoCommand {
    ...
    private SaveGroupHandler saveGroupHandler = NabuccoInjector.getInstance(SaveAuthorizationGroupCommand.class)
            .inject(SaveGroupHandler.class);
