...
/**
 * OpenCorrespondingGroupEditViewCommand
 * <p/>
 * @TODO
 * <p/>
 * 
...
public class OpenCorrespondingGroupEditViewCommand implements NabuccoCommand {
    ...
    private OpenCorrespondingGroupEditViewHandler openCorrespondingGroupEditViewHandler = NabuccoInjector.getInstance(
            OpenCorrespondingGroupEditViewCommand.class).inject(OpenCorrespondingGroupEditViewHandler.class);
