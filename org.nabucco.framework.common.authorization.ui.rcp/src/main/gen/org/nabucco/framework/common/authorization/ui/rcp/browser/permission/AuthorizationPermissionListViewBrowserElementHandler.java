...
public interface AuthorizationPermissionListViewBrowserElementHandler extends CommandHandler {
     ...
     * 
     * @param element
     *            the AuthorizationPermissionListViewBrowserElement.
     * @param viewModel
     *            the AuthorizationPermissionListViewModel.
     */
     ...
     *            the BrowserElement.
     */
    void removeChild(final BrowserElement toBeRemoved, final AuthorizationPermissionListViewBrowserElement element);
}
