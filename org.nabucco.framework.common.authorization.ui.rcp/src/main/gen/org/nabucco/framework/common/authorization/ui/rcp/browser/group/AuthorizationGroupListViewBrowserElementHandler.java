...
public interface AuthorizationGroupListViewBrowserElementHandler extends CommandHandler {
     ...
     * 
     * @param element
     *            the AuthorizationGroupListViewBrowserElement.
     * @param viewModel
     *            the AuthorizationGroupListViewModel.
     */
     ...
     *            the BrowserElement.
     */
    void removeChild(final BrowserElement toBeRemoved, final AuthorizationGroupListViewBrowserElement element);
}
