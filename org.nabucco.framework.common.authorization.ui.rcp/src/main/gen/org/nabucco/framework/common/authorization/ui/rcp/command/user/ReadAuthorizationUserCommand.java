...
public class ReadAuthorizationUserCommand implements NabuccoCommand {
    ...
    private ReadUserHandler readUserHandler = NabuccoInjector.getInstance(ReadAuthorizationUserCommand.class).inject(
            ReadUserHandler.class);
