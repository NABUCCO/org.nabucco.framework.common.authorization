...
public interface AuthorizationRoleListViewBrowserElementHandler extends CommandHandler {
     ...
     * 
     * @param element
     *            the AuthorizationRoleListViewBrowserElement.
     * @param viewModel
     *            the AuthorizationRoleListViewModel.
     */
     ...
     *            the BrowserElement.
     */
    void removeChild(final BrowserElement toBeRemoved, final AuthorizationRoleListViewBrowserElement element);
}
