...
public class AddAuthorizationGroupCommand implements NabuccoCommand {
    ...
    private AddGroupHandler addGroupHandler = NabuccoInjector.getInstance(AddAuthorizationGroupCommand.class).inject(
            AddGroupHandler.class);
