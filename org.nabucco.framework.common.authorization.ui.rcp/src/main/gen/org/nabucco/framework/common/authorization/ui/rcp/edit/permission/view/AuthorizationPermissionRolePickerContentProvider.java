...
/**
 * AuthorizationPermissionRolePickerContentProvider<p/>Edit view for datatype AuthorizationPermission<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2010-01-18
 */
public class AuthorizationPermissionRolePickerContentProvider implements
        ElementPickerContentProvider, NabuccoInjectionReciever {

    private AuthorizationPermissionRolePickerContentProviderHandler handler = NabuccoInjector
            .getInstance(AuthorizationPermissionRolePickerContentProvider.class).inject(
     ...
     */
    public AuthorizationPermissionRolePickerContentProvider(
