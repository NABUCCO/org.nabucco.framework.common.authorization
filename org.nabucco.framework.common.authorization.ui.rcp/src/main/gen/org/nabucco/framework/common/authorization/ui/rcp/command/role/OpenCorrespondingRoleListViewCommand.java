...
/**
 * OpenCorrespondingRoleListViewCommand
 * <p/>
...
public class OpenCorrespondingRoleListViewCommand implements NabuccoCommand {
    ...
    private OpenCorrespondingRoleListViewHandler openCorrespondingRoleListViewHandler = NabuccoInjector.getInstance(
            OpenCorrespondingRoleListViewCommand.class).inject(OpenCorrespondingRoleListViewHandler.class);
