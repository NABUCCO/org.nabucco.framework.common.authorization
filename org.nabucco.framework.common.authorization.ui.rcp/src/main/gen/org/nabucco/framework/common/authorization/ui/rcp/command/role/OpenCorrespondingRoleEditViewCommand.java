...
public class OpenCorrespondingRoleEditViewCommand implements NabuccoCommand {
    ...
    private OpenCorrespondingRoleEditViewHandler openCorrespondingRoleEditViewHandler = NabuccoInjector.getInstance(
            OpenCorrespondingRoleEditViewCommand.class).inject(OpenCorrespondingRoleEditViewHandler.class);
