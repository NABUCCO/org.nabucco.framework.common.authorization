...
/**
 * AuthorizationPermissionGroupPickerHandler<p/>Edit view for datatype AuthorizationPermission<p/>
 *
 * @version 1.0
...
public class AuthorizationPermissionGroupPickerHandler implements ElementPickerListener {
     ...
     */
    public AuthorizationPermissionGroupPickerHandler(
            final AuthorizationPermissionEditViewModel model) {
        super();
        this.model = model;
    }
