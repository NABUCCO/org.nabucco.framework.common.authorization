...
public class SaveAuthorizationRoleCommand implements NabuccoCommand {
    ...
    private SaveRoleHandler saveRoleHandler = NabuccoInjector.getInstance(SaveAuthorizationRoleCommand.class).inject(
            SaveRoleHandler.class);
