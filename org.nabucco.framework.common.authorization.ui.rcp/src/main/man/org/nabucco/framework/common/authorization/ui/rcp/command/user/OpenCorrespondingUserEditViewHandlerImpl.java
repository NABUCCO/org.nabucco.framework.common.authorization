 ...
 */
public class OpenCorrespondingUserEditViewHandlerImpl
        extends
        AbstractOpenCorrespondingEditViewHandlerImpl<AuthorizationUserEditViewModel, AuthorizationUser>
        implements OpenCorrespondingUserEditViewHandler {
     ...
     */
    @Override
    protected void openCorrespondingEditView(AuthorizationUserEditViewModel model,
