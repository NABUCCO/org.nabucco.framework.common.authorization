...
/**
 * AuthorizationPermissionSearchLayouter
 * 
 * @author Nicolas Moser PRODYNA AG
 */
public class AuthorizationPermissionSearchViewLayouter extends
        BaseSearchViewLayouter<AuthorizationPermissionSearchViewModel> implements
        NabuccoLayouter<AuthorizationPermissionSearchViewModel> {

    private static final String MESSAGE_OWNER_ID = "org.nabucco.framework.common.authorization.ui.rcp.search.permission.view.AuthorizationPermissionSearchViewLayouter";

    private static final String SECTION_TITLE = AuthorizationPermissionSearchView.ID + ".section";

    private AuthorizationPermissionSearchViewWidgetFactory widgetFactory;
