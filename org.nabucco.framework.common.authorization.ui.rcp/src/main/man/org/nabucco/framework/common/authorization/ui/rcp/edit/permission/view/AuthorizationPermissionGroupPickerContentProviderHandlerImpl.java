...
public class AuthorizationPermissionGroupPickerContentProviderHandlerImpl implements
    ...
    @Override
    public Map<String, AuthorizationGroup[]> loadAllAuthorizationGroup(AuthorizationPermissionEditViewModel viewModel) {
    ...
    private Map<String, AuthorizationGroup[]> loadAllAuthorizationGroups(AuthorizationPermissionEditViewModel viewModel) {
