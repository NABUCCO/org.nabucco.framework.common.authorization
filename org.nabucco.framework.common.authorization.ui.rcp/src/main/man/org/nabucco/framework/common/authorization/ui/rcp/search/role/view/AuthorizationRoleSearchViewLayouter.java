...
/**
 * Layouter for AuthorizationRole.
 * 
...
public class AuthorizationRoleSearchViewLayouter extends
    ...
    private static final String SECTION_TITLE = AuthorizationRoleSearchView.ID + ".section";

    private AuthorizationRoleSearchViewWidgetFactory widgetFactory;
