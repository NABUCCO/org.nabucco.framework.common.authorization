...
/**
 * OpenCorrespondingUserListViewHandlerImpl
 * 
 * @author Michael Krausse, PRODYNA AG
 */
public class OpenCorrespondingUserListViewHandlerImpl
        extends
        AbstractNabuccoOpenCorrespondingListViewHandlerImpl<AuthorizationUserListViewBrowserElement, AuthorizationUserListViewModel>
        implements OpenCorrespondingUserListViewHandler {

    /**
     * {@inheritDoc}
     */
    @Override
    public void openCorrespondingUserListView() {
        run();
    }
