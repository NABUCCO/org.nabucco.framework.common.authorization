...
public class AuthorizationUserListViewBrowserElementHandlerImpl
    ...
    @Override
    public void createChildren(AuthorizationUserListViewModel viewModel, AuthorizationUserListViewBrowserElement element) {
    ...
    private void fullLoadChildren(AuthorizationUserListViewModel viewModel) {
        try {
            ...
            viewModel.setElements(response.getAuthorizationUserList().toArray(new AuthorizationUser[0]));
        } catch (Exception e) {
            Activator.getDefault().logError(e);
        }
    }

    private AuthorizationUserListMsg createAuthorizationGroupListMsg(AuthorizationUserListViewModel viewModel) {
    ...
    @Override
    public void removeChild(BrowserElement toBeRemoved, AuthorizationUserListViewBrowserElement element) {
    ...
    @Override
    public void updateViewModel(List<AuthorizationUser> elements, AuthorizationUserListViewModel viewModel) {
