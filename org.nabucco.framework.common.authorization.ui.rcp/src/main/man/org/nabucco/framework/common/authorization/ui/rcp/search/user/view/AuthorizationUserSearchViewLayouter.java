 ...
 */
public class AuthorizationUserSearchViewLayouter extends BaseSearchViewLayouter<AuthorizationUserSearchViewModel>
        implements NabuccoLayouter<AuthorizationUserSearchViewModel> {
    ...
    public Composite layoutComposite(Composite parent, NabuccoMessageManager msgManager,
            AuthorizationUserSearchViewModel model, Layoutable<AuthorizationUserSearchViewModel> view) {
