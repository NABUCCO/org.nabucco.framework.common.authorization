...
public class OpenCorrespondingPermissionEditViewFromBrowserElementCommandHandlerImpl
    ...
    private void loadFull(AuthorizationPermissionEditViewModel model) {
        try {
            ...
            final AuthorizationPermissionMsg msg = this.createAuthorizationPermissionMsg(model
                    .getPermission());

            final AuthorizationPermissionMaintainMsg response = resolveService
                    .resolveAuthorizationPermission(msg);
     ...
     */
    private AuthorizationPermissionMsg createAuthorizationPermissionMsg(
