 ...
 */
public class SaveUserHandlerImpl extends
        AbstractSaveCommandHandlerImpl<AuthorizationUserEditBusinessModel, AuthorizationUserEditViewModel> implements
        SaveUserHandler {
    ...
    @Override
    protected void saveModel(AuthorizationUserEditViewModel viewModel, AuthorizationUserEditBusinessModel businessModel)
