...
/**
 * OpenCorrespondingRoleListViewHandlerImpl
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class OpenCorrespondingRoleListViewHandlerImpl
        extends
        AbstractNabuccoOpenCorrespondingListViewHandlerImpl<AuthorizationRoleListViewBrowserElement, AuthorizationRoleListViewModel>
        implements OpenCorrespondingRoleListViewHandler {

    @Override
    public void openCorrespondingRoleListView() {
        super.run();
    }
