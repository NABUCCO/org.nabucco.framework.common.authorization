...
import org.nabucco.framework.common.authorization.ui.rcp.list.role.view.AuthorizationRoleListView;
import org.nabucco.framework.plugin.base.command.AbstractOpenCorrespondingEditViewHandlerImpl;

/**
 * OpenCorrespondingRoleEditViewHandlerImpl
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class OpenCorrespondingRoleEditViewHandlerImpl extends
        AbstractOpenCorrespondingEditViewHandlerImpl<AuthorizationRoleEditViewModel, AuthorizationRole> implements
        OpenCorrespondingRoleEditViewHandler {

    @Override
    public void openCorrespondingRoleEditView() {
        run();
    }
    ...
    @Override
    protected void openCorrespondingEditView(AuthorizationRoleEditViewModel model, AuthorizationRole role) {
        model.setRole(role);
    }
}
