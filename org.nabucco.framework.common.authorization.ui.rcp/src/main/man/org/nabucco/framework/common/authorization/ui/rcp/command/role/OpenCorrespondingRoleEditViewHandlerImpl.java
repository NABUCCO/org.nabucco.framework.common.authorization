 ...
 */
public class OpenCorrespondingRoleEditViewHandlerImpl
        extends
        AbstractOpenCorrespondingEditViewHandlerImpl<AuthorizationRoleEditViewModel, AuthorizationRole>
        implements OpenCorrespondingRoleEditViewHandler {
    ...
    @Override
    protected void openCorrespondingEditView(AuthorizationRoleEditViewModel model,
