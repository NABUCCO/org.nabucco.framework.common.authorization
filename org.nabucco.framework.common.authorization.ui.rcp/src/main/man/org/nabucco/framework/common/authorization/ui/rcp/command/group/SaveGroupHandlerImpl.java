 ...
 */
public class SaveGroupHandlerImpl
        extends
        NabuccoAbstractSaveCommandHandlerImpl<AuthorizationGroupEditBusinessModel, AuthorizationGroupEditViewModel>
        implements SaveGroupHandler {
     ...
     */
    @Override
    protected void saveModel(final AuthorizationGroupEditViewModel viewModel,
            final AuthorizationGroupEditBusinessModel businessModel) {
