...
public class AuthorizationUserRoleRelation extends NabuccoDatatype implements Datatype {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(AuthorizationUserRoleRelation.getPropertyDescriptor(ROLE), this.getRole(),
                null));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(AuthorizationUserRoleRelation.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(AuthorizationUserRoleRelation.class).getAllProperties();
    }
}
