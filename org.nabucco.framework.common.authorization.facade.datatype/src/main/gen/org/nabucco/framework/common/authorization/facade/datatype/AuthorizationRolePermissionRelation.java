...
public class AuthorizationRolePermissionRelation extends NabuccoDatatype implements Datatype {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(AuthorizationRolePermissionRelation.getPropertyDescriptor(PERMISSION),
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(AuthorizationRolePermissionRelation.class)
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(AuthorizationRolePermissionRelation.class).getAllProperties();
    }
}
