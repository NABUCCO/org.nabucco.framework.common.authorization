 ...
 */
package org.nabucco.framework.common.authorization.facade.service.importing;
...
/**
 * ImportAuthorization<p/>Authorization Import Service<p/>
 *
 * @version 1.0
 * @author Silas Schwarz, PRODYNA AG, 2011-02-10
 */
public interface ImportAuthorization extends Service {
     ...
     */
    ServiceResponse<ImportRs> importAuthoritation(ServiceRequest<ImportRq> rq) throws ImportException;
}
