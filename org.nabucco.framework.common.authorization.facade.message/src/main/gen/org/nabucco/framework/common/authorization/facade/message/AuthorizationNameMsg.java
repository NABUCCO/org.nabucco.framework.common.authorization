...
public class AuthorizationNameMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(AuthorizationNameMsg.getPropertyDescriptor(NAME), this.name));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(AuthorizationNameMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(AuthorizationNameMsg.class).getAllProperties();
    }
}
