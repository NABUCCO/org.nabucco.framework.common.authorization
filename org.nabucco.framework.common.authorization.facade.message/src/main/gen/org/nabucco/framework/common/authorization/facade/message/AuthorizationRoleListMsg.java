...
public class AuthorizationRoleListMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** The list of authorization roles. */
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(AuthorizationRoleListMsg.getPropertyDescriptor(AUTHORIZATIONROLELIST),
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(AUTHORIZATIONROLELIST) && (property.getType() == AuthorizationRole.class))) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(AuthorizationRoleListMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(AuthorizationRoleListMsg.class).getAllProperties();
    }
}
