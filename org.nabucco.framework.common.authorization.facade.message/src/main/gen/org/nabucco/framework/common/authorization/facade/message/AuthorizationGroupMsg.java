...
public class AuthorizationGroupMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(AuthorizationGroupMsg.getPropertyDescriptor(AUTHORIZATIONGROUP),
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(AUTHORIZATIONGROUP) && (property.getType() == AuthorizationGroup.class))) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(AuthorizationGroupMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(AuthorizationGroupMsg.class).getAllProperties();
    }
}
